<?php $__env->startSection('content'); ?>
	...
	<body>
		<div class="form-dhruvi">
			<form method="post" action="<?php echo e(url('form-builder')); ?>">
				<?php echo csrf_field(); ?>
				<div class="row">
					<div class="col-lg-9 ">
...
<?php echo $__env->make('Admin.layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chiraggupta/Sites/localhost/chirag/srchout/infospeed_admin/resources/views/Admin/form-builder/form.blade.php ENDPATH**/ ?>