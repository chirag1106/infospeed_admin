          ...
          <div class="modal-body">
            <div class="card" style="border:none; box-shadow: none !important;">
              <div class="col-xl-12 mx-auto">
                <form method="post" action="<?php echo e(url('vidhansabha')); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
  ...
  <div class="col-lg-12 p-lg-0">
    <div class="card mb-4">
        ...
        <div class="" style="overflow-x:auto !important;">
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              ...
              <?php $__currentLoopData = $vidhansabha; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="table-form">
                <form method="post" action="<?php echo e(url('edit-vidhansabha').'/'.$item->id); ?>" id="form-id">
                  ...
                  <td>
                    ...
                    <input type="text" class="form-control form_input d-none text-capitalize" style="width:100%" name="vs_name" value="<?php echo e($item->vs_name ?? ''); ?>" required>
                  </td>
                  ...
                  <td class="actions">
                    ...
                    <div class="table-action text-center" style="display: block;">
                      ...
                      <a href="<?php echo e(url('delete-vidhansabha').'/'.$item->id); ?>" class="emp_delete mb-0 text-center" data-toggle="tooltip" data-placement="bottom" title="Delete"><img src="<?php echo e(asset('/assets/img/delete.png')); ?>" alt="" class="img-fluid mx-1"></a>
                    </div>
                  </td>
                </form>
                <?php if($item->vidhan_status==2): ?>
                <td class="text-center">
                  <form method="GET" action="<?php echo e(url('/')); ?>/vidhansabha-active/<?php echo e($item->id ?? ''); ?>">
                    <input type="checkbox" data-toggle="toggle" data-on=" " data-off=" " data-style="ios" data-key="check<?php echo e($key); ?>" checked>
                  </form>
                </td>
                <?php else: ?>
                <td class="text-center">
                  <form method="GET" action="<?php echo e(url('/')); ?>/vidhansabha-deactive/<?php echo e($item->id ?? ''); ?>">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center align-content-center mb-1 mt-1 mx-auto">
        <?php echo e($vidhansabha->links('pagination::bootstrap-4')); ?>

        <!-- <?php echo e($vidhansabha->links('pagination::simple-tailwind')); ?> -->
        <!-- <?php echo e($vidhansabha->links('pagination::semantic-ui')); ?>
...
<?php echo $__env->make('Admin.layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chiraggupta/Sites/localhost/chirag/srchout/infospeed_admin/resources/views/Admin/vidhanSabha/vidhanSabha.blade.php ENDPATH**/ ?>