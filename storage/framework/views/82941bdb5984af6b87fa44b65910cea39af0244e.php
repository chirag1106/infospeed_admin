      ...
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content p-3" style="border-radius: 20px;">
          ...
          <div class="modal-header d-flex justify-content-center align-items-center align-content-center btn-primary text-white" style="border-bottom: none; border-top-left-radius: none; border-top-right-radius: none ">
            <h5 class="modal-title text-center ps-4 text-white" style="text-transform: capitalize;" id="exampleModalLabel" style="font-weight: 700; "><?php echo e($loksabha->ls_name ?? ''); ?></h5>
          ...
          <div class="modal-body">
            <div class="card" style="border:none; box-shadow:none !important; ">
              <div class="col-xl-12 mx-auto">
                <form method="post" action="<?php echo e(url('lok-vidhan')); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="listings-container  px-3 my-2">
                    <input type="hidden" name="loksabha_id" value="<?php echo e($loksabha->id ?? ''); ?>">
  ...
  <div class="col-lg-12 p-0">
    <div class="card mb-4">
      <div class="card-header pb-0">
        <h6 style="font-size: 1.5rem;font-weight:bold; text-transform: capitalize;"> <?php echo e($loksabha->ls_name ?? ''); ?></h6>
      </div>
      <div class="card-body  pt-0 pb-2">
        <div class="" style="overflow-x:auto !important ;">
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              <?php $__currentLoopData = $vidhan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="table-form">
                <form method="post" action="<?php echo e(url('edit-vidhansabha').'/'.$item->id); ?>" id="form-id">
                  <?php echo csrf_field(); ?>
                  <td class="text-center">
                    <div class=" px-2">
                      <div class="my-auto">
                        <a href="<?php echo e(url('vidhan-block').'/'.$item->id); ?>" target="blank"><label class="input_label pointer"><?php echo e($item->vs_name ?? ''); ?></label></a>
                        <input type="text" class="form-control form_input d-none text-capitalize" name="vs_name" style="width:100%" type="text" id="ls_name" value="<?php echo e($item->vs_name ?? ''); ?>" required>
                      </div>
                    </div>
                  </td>
                  <td class="actions text-center">
                    ...
                    <div class="table-action text-center" style="display: block;">
                      ...
                      <a href="<?php echo e(url('delete-vidhansabha').'/'.$item->id); ?>" class="emp_delete mb-0 text-center"><img src="<?php echo e(asset('/assets/img/delete.png')); ?>" alt="" class="img-fluid mx-1"></a>
                    </div>
                  </td>
                </form>
      ...
      <div class="d-flex flex-column justify-content-center align-items-center align-content-center mb-1 mt-1 mx-auto">
        <?php echo e($vidhan->links('pagination::bootstrap-4')); ?>

        <!-- <?php echo e($vidhan->links('pagination::simple-tailwind')); ?> -->
        <!-- <?php echo e($vidhan->links('pagination::semantic-ui')); ?>
...
<?php echo $__env->make('Admin.layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/chiraggupta/Sites/localhost/chirag/srchout/infospeed_admin/resources/views/Admin/lokSabha/lok-vidhan.blade.php ENDPATH**/ ?>