            ...
            <div class="card" style="border-radius:50px; border:5px solid #fff">
              <div class="row g-0">
                <div class="col-md-6 col-lg-5 d-none d-md-block">
                  <img src="{{ asset('/assets/img/login.png') }}" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                </div>
                  ...
                  <div class="card-body p-md-4 p-lg-5 text-black">
                    ...
                    <form action="{{url('/')}}/login" method="post">
                      ...
                      {{-- <div class="form-check form-switch clearfix">
                        <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold d-inline-block float-end" style="font-size: 0.95rem;">Recovery Password</a>
                      </div> --}}
